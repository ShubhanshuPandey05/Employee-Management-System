    ...
    <>
        <form>
            ...
            <h2 className='text-2xl mt-14 mb-8 font-bold mx-36'>Sign in</h2>
                <input type="email" name='UserName' className='h-10 p-5 rounded-lg w-64 mx-5 my-4' value={data.Email} placeholder='Username' onChange={(event)=>{setData({...data,Email:event.target.value})}}/> <br />
